...
class Suhu:
    ...
    def plot(self):
        plt.plot(self.t,np.full(len(self.temperature),self.average),color='blue',label='2) Average Body Temp')
        plt.plot(self.t,self.temperature,color='black',label='1) Readed Body Temp')
